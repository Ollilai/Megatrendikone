...
export default function AboutPage() {
    return (
        <>
            <Header />
            <div className="min-h-screen bg-slate-50 noise text-slate-900">
                ...
                <div className="relative z-10 py-12 px-4">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-bold text-slate-900 mb-8">Tietoa palvelusta</h1>

                        {/* About Megatrendikone */}
                        <section className="glass rounded-2xl p-6 md:p-8 mb-8">
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Mikä on Megatrendikone?</h2>
                        ...
                        <section className="glass rounded-2xl p-6 md:p-8 mb-8">
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Miten Megatrendikone toimii?</h2>
                            ...
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
                                        <span className="text-primary-600">1.</span> Organisaatiosi tietojen keräys
                                    </h3>
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
                                        <span className="text-primary-600">2.</span> RAG-haku Sitran megatrendidatasta
                                    </h3>
                                    <p className="text-slate-700 leading-relaxed ml-6 mb-3">
                                    ...
                                    <div className="ml-6 bg-slate-100 rounded-lg p-4 border border-slate-200 mb-3">
                                        <p className="text-sm font-mono text-slate-600 mb-2">RAG-prosessi:</p>
                                        <ul className="text-sm text-slate-600 space-y-2 ml-4">
                                            <li>
                                                <strong className="text-slate-900">1. Vektorisointi:</strong> Sitran tekoäly-ystävällinen JSON-julkaisu on käsitelty
                                                semanttisiksi chunkeiksi (~250 osiota). Jokaiselle on luotu OpenAI text-embedding-3-small -vektori.
                                            </li>
                                            <li>
                                                <strong className="text-slate-900">2. Semanttinen haku:</strong> Organisaatiosi tiedot muunnetaan
                                                samanlaiseksi vektoriksi ja haetaan 10 relevanteinta osiota Sitran datasta (cosine similarity).
                                            </li>
                                            <li>
                                                <strong className="text-slate-900">3. Kontekstin injektio:</strong> Nämä löydetyt osiot injektoidaan
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
                                        <span className="text-primary-600">3.</span> Megatrendi-analyysi (GPT-5.1 o1)
                                    </h3>
                                    <p className="text-slate-700 leading-relaxed ml-6 mb-3">
                                    ...
                                    <div className="ml-6 bg-slate-100 rounded-lg p-4 border border-slate-200">
                                        <p className="text-sm font-mono text-slate-600 mb-2">Promptin rakenne:</p>
                                        <ul className="text-sm text-slate-600 space-y-1 ml-4">
                                            <li>• Organisaation perustiedot ja toiminta</li>
                                            <li>• <strong className="text-primary-600">RAG-haulla löydetyt relevanteimmat osiot Sitran raportista</strong></li>
                                    ...
                                    <p className="text-slate-700 leading-relaxed ml-6 mt-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
                                        <span className="text-primary-600">4.</span> Tulevaisuuskuvan generointi (Gemini 2.5 Flash Image)
                                    </h3>
                                    <p className="text-slate-700 leading-relaxed ml-6 mb-3">
                                    ...
                                    <div className="ml-6 bg-slate-100 rounded-lg p-4 border border-slate-200">
                                        <p className="text-sm font-mono text-slate-600 mb-2">Kuva-promptin elementit:</p>
                                        <ul className="text-sm text-slate-600 space-y-1 ml-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
                                        <span className="text-primary-600">5.</span> Tulosten esittäminen
                                    </h3>
                                    <p className="text-slate-700 leading-relaxed ml-6">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-slate-900 mb-2 flex items-center gap-2">
                                        <span className="text-primary-600">📊</span> Tekninen arkkitehtuuri
                                    </h3>
                                    <div className="ml-6 space-y-2">
                                        <p className="text-slate-700"><strong>Frontend:</strong> Next.js 15, React, TypeScript, Tailwind CSS</p>
                                        <p className="text-slate-700"><strong>Backend:</strong> Next.js API Routes (palvelinkomponentit)</p>
                                        <p className="text-slate-700"><strong>Tekoälymallit:</strong> OpenAI GPT-5.1 o1 (analyysi), Google Gemini 2.5 Flash Image (kuvat), OpenAI text-embedding-3-small (RAG)</p>
                                        <p className="text-slate-700"><strong>RAG-järjestelmä:</strong> Pre-computed embeddings (~250 chunks Sitran JSON-datasta), in-memory cosine similarity search</p>
                                        <p className="text-slate-700"><strong>Hosting:</strong> Vercel (Edge Network)</p>
                                        <p className="text-slate-700"><strong>Välimuisti:</strong> Vercel KV (Redis) – 24h säilytys</p>
                        ...
                        <section className="glass rounded-2xl p-6 md:p-8 mb-8">
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Sitran megatrendit 2026</h2>
                            <p className="text-slate-700 leading-relaxed mb-6">
                            ...
                            <ul className="space-y-3 text-slate-700 mb-6">
                                <li className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <strong className="text-slate-900">Teknologia</strong> – Tekoäly mullistaa yhteiskunnan perustaa
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-xl">🌿</span>
                                    <div>
                                        <strong className="text-slate-900">Luonto</strong> – Ympäristökriisi pakottaa sopeutumaan
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-xl">👥</span>
                                    <div>
                                        <strong className="text-slate-900">Ihmiset</strong> – Suuntana pitkäikäisten yhteiskunta
                                    </div>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="text-xl">⚖️</span>
                                    <div>
                                        <strong className="text-slate-900">Valta</strong> – Maailmanjärjestyksen murros mittaa demokratian voiman
                                    </div>
                                </li>
                            </ul>
                        ...
                        {/* Consulting CTA */}
                        <section className="bg-gradient-to-br from-primary-50 to-accent-50 border border-primary-200 rounded-2xl p-6 md:p-8 mb-8">
                            <h2 className="text-2xl font-bold text-slate-900 mb-4">Moi!</h2>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-slate-200 hover:bg-slate-300 text-slate-900 font-semibold rounded-xl transition-all"
                                >
                        ...
                        <div className="text-center">
                            <Link
                                href="/"
                                className="inline-flex items-center gap-2 px-6 py-3 border border-slate-300 hover:border-slate-400 text-slate-600 hover:text-slate-900 font-semibold rounded-xl transition-all"
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                                </svg>
