        ...
        <div className="min-h-screen bg-slate-950 noise text-slate-50">
            ...
            <div className="relative z-10 py-8 md:py-12 px-4">
                ...
                >
                            ...
                            {megatrendKeys.map((key) => {
                                ...
                                return (
                                    <div key={key} className="bg-slate-900/50 rounded-xl p-5 border border-slate-700/30 hover:border-slate-600 transition-colors">
                                        <h3 className="font-bold text-white text-lg mb-1" style={{ color: trend.color }}>
                                            {trend.label}
                                        </h3>
                    ...
                    >
                        <h3 className="text-xl font-bold text-amber-400 mb-4">YLLÄTTÄVÄ UHKA</h3>
                    ...
                    <motion.div
                        ...
                        className="bg-gradient-to-br from-purple-500/10 to-indigo-500/10 border border-purple-500/20 rounded-2xl p-6 md:p-8 mb-12"
                    >
                        <h3 className="text-xl font-bold text-purple-400 mb-4 flex items-center gap-2">
                            <span>🤝</span> ROOLI UUDESSA YHTEISKUNTASOPIMUKSESSA
                        </h3>
                        <p className="text-slate-300 leading-relaxed">{result.socialContract.role}</p>
                    </motion.div>
